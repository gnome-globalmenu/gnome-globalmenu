...
patch '/parent_class)->expose_event/s/, &_tmp[0-9])/)/g' menuitem.c window.c label.c
...
patch 's/callback, callback_target, data/include_internals, callback, callback_target/g' menuitem.c menubar.c menubarbox.c label.c
